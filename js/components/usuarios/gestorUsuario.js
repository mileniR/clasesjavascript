...
class GestorUsuarios {
    ...
    renderizarUsuarios(usuarios) {
        ...
        usuarios.forEach(usuario => { 
            ...
            $('#mainlogin').append(`
                <div class="usuario">
                    <div class="name">Nombre: ${usuario.name}</div>
                    <div class="img"><img src="${usuario.img}"></div>
                    <div class="dni">Dni: ${usuario.dni}</div>
                    <div class="edad" style="${colorEdad}">Edad: ${usuario.edad}</div>
                    <div class="estadocivil">Estado Civil: ${usuario.estadocivil}</div>
                </div>
            `);
        });
    }
